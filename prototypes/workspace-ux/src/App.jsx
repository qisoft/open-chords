...
const INITIAL_BARS = [
  ...
  { id: 'bar-3', number: 3, meter: '4/4', section: 'Куплет 1', confidence: 'ok', events: [
    { id: '3-c', chord: 'C', duration: 4 }, { id: '3-g7', chord: 'G7', duration: 4 },
    { id: '3-am', chord: 'Am', duration: 2 }, { id: '3-f', chord: 'F', duration: 2 },
    { id: '3-dm', chord: 'Dm', duration: 4 },
  ] },
...
function EventEditor({ state, bar, event, dispatch }) {
  ...
  return <aside className="inspector panel editor-dock" aria-label="Редактор выбранного события аккорда">
    ...
    <form onSubmit={save}>
      <div className="field-group"><div className="chord-control"><span className="chord-control-label"><Music2 size={12} aria-hidden="true" />Аккорд</span><details ref={chordPickerRef} className="chord-picker-dropdown" onToggle={(toggleEvent) => { if (toggleEvent.currentTarget.open) setChordPickerStep('root') }}>
