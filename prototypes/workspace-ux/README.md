...
- chord names are never free-form: a collapsed chord row opens a compact dropdown with controlled root, type, optional bass, and explicit `N` choices, then shows the exact supported symbol before save;
