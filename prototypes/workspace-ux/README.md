...
- bar edits live in an isolated draft: chord, duration, add/delete, and reorder changes stay inside the editor until a valid Save publishes the whole bar to the timeline and lyrics; `Отменить правки` discards even an invalid draft back to the last saved bar.
