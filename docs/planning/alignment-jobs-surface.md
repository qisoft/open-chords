...
The local MFA payload measures 667,448,770 installed bytes and 288,756,437 transfer bytes. Per-target final CI measurements and Windows installed evidence must be recorded in the PR before readiness.
