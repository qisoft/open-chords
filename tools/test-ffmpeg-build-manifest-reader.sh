...
windows_frozen_runtime_system_dlls="$(bash "${manifest_reader}" array "${fixture_root}/valid.json" windowsFrozenRuntimeSystemDlls "${reader}")"
[[ "${windows_frozen_runtime_system_dlls}" == $'COMCTL32.dll\nKERNEL32.dll' ]]
